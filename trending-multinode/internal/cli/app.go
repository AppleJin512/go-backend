...
func NewApp() *cli.App {
	return &cli.App{
		...
		Version: "0.1.0",
		Flags: []cli.Flag{
			&cli.StringFlag{Name: "dsnDb", Value: "postgresql://trending:trending@localhost:5432/trending?sslmode=disable", EnvVars: []string{"DSN_DB"}},
			...
			&cli.StringSliceFlag{Name: "nodes", Value: cli.NewStringSlice("wss://solana-api.projectserum.com", "wss://api.mainnet-beta.solana.com"), EnvVars: []string{"NODES"}},
